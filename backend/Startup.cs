...
namespace Interchoice
{
    ...
    {
        public static string _conStr = "User ID=postgres;Password=postgrespw;Host=localhost;Port=5432;Database=interchoice;Pooling=true;Min Pool Size=0;Max Pool Size=100;Connection Lifetime=0;";
